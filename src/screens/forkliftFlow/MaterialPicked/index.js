...
const MaterialPicked = ({ navigation }) => {
    const [isMaterialPicked, setIsMaterialPicker] = useState(false);

    const handleMaterialPicked = () => {
        setIsMaterialPicker(true);
        console.log("✅ Material has been picked!");
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{
                ...
                <AppButton
                    title={isMaterialPicked ? "Marked as Completed" : "Material Picked"}
