      ...
      <View style={styles.content}>
        ...
        <FlatList
          ...
          contentContainerStyle={
            logs.length === 0 ? { flex: 1 } : { paddingBottom: heightPixel(20) }
          }
          renderItem={({ item }) => (
            <TouchableOpacity
              style={styles.workPackItem}
              onPress={() => navigation.navigate(routes.hsLogDetail, { log: item })}
              activeOpacity={0.8}
            >
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                ...
                />
                <Text style={styles.time}>{item?.date || item?.activeDate || "N/A"}</Text>
              </View>
